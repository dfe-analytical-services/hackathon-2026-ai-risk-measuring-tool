  ...
  nav_panel(
    ...
    div(
      ...
      card(
        ...
        p(
          "AI Spy helps analysts identify potential risks associated ",
        ...
        strong("AI Spy is a decision-support tool."),
      ...
      card(
        ...
        card_header(
          h4("Tell AI Spy about your use case")
        ),
  ...
  output$overall_action <- renderUI({
    ...
    if (
      ...
      tagList(
        ...
        p(
          "AI Spy has identified one or more mandatory escalation conditions."
        ),
